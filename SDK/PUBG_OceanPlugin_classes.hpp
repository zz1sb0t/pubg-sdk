...
{
public:
	bool                                               EnableGerstnerWaves;                                      // 0x03B0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x03B1(0x0003) MISSED OFFSET
	struct FVector2D                                     GlobalWaveDirection;                                      // 0x03B4(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	...
	bool                                               bEnableLandscapeModulation;                               // 0x03EC(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	bool                                               attachToPlayer;                                           // 0x03DC(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               DebugMode;                                                // 0x03DD(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	bool                                               isLeader;                                                 // 0x0428(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FVector                                     underwaterMin;                                            // 0x0498(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	struct FVector                                     underwaterMax;                                            // 0x04A4(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	...
	bool                                               DebugMode;                                                // 0x04D0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	bool                                               bAllowDaylightSavings;                                    // 0x03DC(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bDaylightSavingsActive;                                   // 0x03DD(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x03DE(0x0002) MISSED OFFSET
