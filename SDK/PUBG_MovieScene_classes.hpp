...
public:
	...
	struct FScriptMulticastDelegate                    OnStop;                                                   // 0x0380(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnPause;                                                  // 0x0390(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
	...
	class UMovieSceneSequence*                         Sequence;                                                 // 0x03A8(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	float                                              TimeCursorPosition;                                       // 0x03B0(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              StartTime;                                                // 0x03B4(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              EndTime;                                                  // 0x03B8(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                CurrentNumLoops;                                          // 0x03BC(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
...
public:
	...
	TMap<class UObject*, struct FCachedMovieSceneEvaluationTemplate> InstancedSubSequenceEvaluationTemplates;                  // 0x02D8(0x0050) (CPF_ZeroConstructor)
