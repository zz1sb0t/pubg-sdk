...
void UBP_FppWeaponListSlotWidget_C::HIddenEnd__DelegateSignature()
{
 ...
 if (!fn) fn = UObject::FindObject<UFunction>(0x67d6ac1b);
...
{
	static UFunction* fn = nullptr; 
 if (!fn) fn = UObject::FindObject<UFunction>(0x224e6246);
...
{
	static UFunction* fn = nullptr; 
 if (!fn) fn = UObject::FindObject<UFunction>(0xf68a2e7c);
...
{
	static UFunction* fn = nullptr; 
 if (!fn) fn = UObject::FindObject<UFunction>(0x3aa3cd0d);
