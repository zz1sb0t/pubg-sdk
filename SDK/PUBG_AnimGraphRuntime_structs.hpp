...
struct FAnimNode_AimOffsetLookAt : public FAnimNode_BlendSpacePlayer
{
	...
	bool                                               bIsLODEnabled;                                            // 0x0144(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0145(0x0003) MISSED OFFSET
	struct FVector                                     LookAtLocation;                                           // 0x0148(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
...
{
	struct FVector                                     TargetTranslation;                                        // 0x0000(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	struct FRotator                                      TargetRotation;                                           // 0x000C(0x000C) (CPF_Edit, CPF_IsPlainOldData)
};
...
struct FPoseDriverTarget
{
	...
	struct FRotator                                      TargetRotation;                                           // 0x0010(0x000C) (CPF_Edit, CPF_IsPlainOldData)
...
struct FAnimNode_PoseDriver : public FAnimNode_PoseHandler
{
	...
	bool                                               bOnlyDriveSelectedBones;                                  // 0x00C8(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x00C9(0x0007) MISSED OFFSET
	...
	EPoseDriverSource                                  DriveSource;                                              // 0x0108(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	EPoseDriverOutput                                  DriveOutput;                                              // 0x0109(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	EPoseDriverType                                    Type;                                                     // 0x0139(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
...
{
	struct FBoneReference                              DrivingBone;                                              // 0x0000(0x0018) (CPF_Edit)
	struct FVector                                     SphereLocalOffset;                                        // 0x0018(0x000C) (CPF_Edit, CPF_IsPlainOldData)
...
struct FAnimNode_AnimDynamics : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bChain;                                                   // 0x0090(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FVector                                     BoxExtents;                                               // 0x00C8(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	struct FVector                                     LocalJointOffset;                                         // 0x00D4(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	float                                              GravityScale;                                             // 0x00E0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bLinearSpring;                                            // 0x00E4(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bAngularSpring;                                           // 0x00E5(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	bool                                               bEnableWind;                                              // 0x00F0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bWindWasEnabled;                                          // 0x00F1(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	...
	bool                                               bOverrideLinearDamping;                                   // 0x00F8(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	bool                                               bOverrideAngularDamping;                                  // 0x0100(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	bool                                               bOverrideAngularBias;                                     // 0x0108(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	bool                                               bDoUpdate;                                                // 0x0110(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bDoEval;                                                  // 0x0111(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	bool                                               bUsePlanarLimit;                                          // 0x0178(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	bool                                               bUseSphericalLimits;                                      // 0x0190(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	EAnimPhysCollisionType                             CollisionType;                                            // 0x01A8(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FVector                                     ExternalForce;                                            // 0x01B0(0x000C) (CPF_Edit, CPF_IsPlainOldData)
...
struct FAnimNode_BoneDrivenController : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bUseRange;                                                // 0x009C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	EDrivenDestinationMode                             DestinationMode;                                          // 0x00B0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	EDrivenBoneModificationMode                        ModificationMode;                                         // 0x00E0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAnimNode_CopyBone : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bCopyTranslation;                                         // 0x00A0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bCopyRotation;                                            // 0x00A1(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bCopyScale;                                               // 0x00A2(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAnimNode_CopyBoneDelta : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bCopyRotation;                                            // 0x00A1(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bCopyScale;                                               // 0x00A2(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	ECopyBoneDeltaMode                                 CopyMode;                                                 // 0x00A3(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAnimNode_Fabrik : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bEnableDebugDraw;                                         // 0x0100(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAnimLegIKDefinition
{
	...
	bool                                               bEnableRotationLimit;                                     // 0x0035(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAnimNode_LookAt : public FAnimNode_SkeletalControlBase
{
	...
	struct FVector                                     LookAtLocation;                                           // 0x00A8(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	...
	struct FVector                                     CustomLookAtAxis;                                         // 0x00B8(0x000C) (CPF_Deprecated, CPF_IsPlainOldData)
	struct FAxis                                       LookAt_Axis;                                              // 0x00C4(0x0010) (CPF_Edit, CPF_BlueprintVisible)
	bool                                               bUseLookUpAxis;                                           // 0x00D4(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FVector                                     CustomLookUpAxis;                                         // 0x00D8(0x000C) (CPF_Deprecated, CPF_IsPlainOldData)
...
{
	struct FBoneReference                              BoneToModify;                                             // 0x0070(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FVector                                     Translation;                                              // 0x0088(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	struct FRotator                                      Rotation;                                                 // 0x0094(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	struct FVector                                     Scale;                                                    // 0x00A0(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
...
struct FAnimNode_ObserveBone : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bRelativeToRefPose;                                       // 0x0089(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x008A(0x0002) MISSED OFFSET
	struct FVector                                     Translation;                                              // 0x008C(0x000C) (CPF_IsPlainOldData)
	struct FRotator                                      Rotation;                                                 // 0x0098(0x000C) (CPF_IsPlainOldData)
	struct FVector                                     Scale;                                                    // 0x00A4(0x000C) (CPF_IsPlainOldData)
};
...
struct FAnimNode_RotationMultiplier : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bIsAdditive;                                              // 0x00A5(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAnimNode_ScaleChainLength : public FAnimNode_Base
{
	...
	struct FVector                                     TargetLocation;                                           // 0x0080(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
...
struct FAnimNode_SplineIK : public FAnimNode_SkeletalControlBase
{
	...
	ESplineBoneAxis                                    BoneAxis;                                                 // 0x00A0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bAutoCalculateSpline;                                     // 0x00A1(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAnimNode_SpringBone : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bLimitDisplacement;                                       // 0x0088(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	bool                                               bNoZSpring;                                               // 0x009C(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	bool                                               bTranslateX;                                              // 0x009D(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bTranslateY;                                              // 0x009E(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bTranslateZ;                                              // 0x009F(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bRotateX;                                                 // 0x00A0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bRotateY;                                                 // 0x00A1(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bRotateZ;                                                 // 0x00A2(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAnimNode_Trail : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bInvertChainBoneAxis;                                     // 0x008D(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FVector                                     FakeVelocity;                                             // 0x0118(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
...
struct FAnimNode_TwoBoneIK : public FAnimNode_SkeletalControlBase
{
	...
	struct FVector                                     EffectorLocation;                                         // 0x0088(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	struct FVector                                     JointTargetLocation;                                      // 0x0094(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	...
	struct FVector2D                                     StretchLimits;                                            // 0x00AC(0x0008) (CPF_Deprecated, CPF_IsPlainOldData)
