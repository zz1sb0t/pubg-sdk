...
struct UCircleMiniMapWidget_C_On_TimeBorder_Prepass_2_Params
{
	class UWidget*                                     BoundWidget;                                              // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};

// Function CircleMiniMapWidget.CircleMiniMapWidget_C.On_GridText_Prepass_1
struct UCircleMiniMapWidget_C_On_GridText_Prepass_1_Params
{
	class UWidget*                                     BoundWidget;                                              // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};

// Function CircleMiniMapWidget.CircleMiniMapWidget_C.On_TimeBorder_Prepass_1
struct UCircleMiniMapWidget_C_On_TimeBorder_Prepass_1_Params
{
	class UWidget*                                     BoundWidget;                                              // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};

// Function CircleMiniMapWidget.CircleMiniMapWidget_C.GetNextPlayzoneDirection
struct UCircleMiniMapWidget_C_GetNextPlayzoneDirection_Params
{
...
struct UCircleMiniMapWidget_C_On_BluezoneTime_Prepass_1_Params
{
	class UWidget*                                     BoundWidget;                                              // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};

// Function CircleMiniMapWidget.CircleMiniMapWidget_C.OnPrepass_2
struct UCircleMiniMapWidget_C_OnPrepass_2_Params
{
	class UWidget*                                     BoundWidget;                                              // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};

// Function CircleMiniMapWidget.CircleMiniMapWidget_C.On_Arrow_Prepass_1
struct UCircleMiniMapWidget_C_On_Arrow_Prepass_1_Params
{
	class UWidget*                                     BoundWidget;                                              // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};

// Function CircleMiniMapWidget.CircleMiniMapWidget_C.OnPrepass_1
struct UCircleMiniMapWidget_C_OnPrepass_1_Params
{
	class UWidget*                                     BoundWidget;                                              // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
