...
{
	static auto fn = UObject::FindObject<UFunction>("Function CircleMiniMapWidget.CircleMiniMapWidget_C.On_TimeBorder_Prepass_2");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function CircleMiniMapWidget.CircleMiniMapWidget_C.On_GridText_Prepass_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function CircleMiniMapWidget.CircleMiniMapWidget_C.On_TimeBorder_Prepass_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function CircleMiniMapWidget.CircleMiniMapWidget_C.GetNextPlayzoneDirection");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function CircleMiniMapWidget.CircleMiniMapWidget_C.On_BluezoneTime_Prepass_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function CircleMiniMapWidget.CircleMiniMapWidget_C.OnPrepass_2");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function CircleMiniMapWidget.CircleMiniMapWidget_C.On_Arrow_Prepass_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function CircleMiniMapWidget.CircleMiniMapWidget_C.OnPrepass_1");
