...
struct FMovieSceneCaptureSettings
{
	...
	bool                                               bOverwriteExisting;                                       // 0x0030(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	bool                                               bUseRelativeFrameNumbers;                                 // 0x0031(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
