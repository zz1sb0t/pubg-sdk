...
void UMessageWidget_C::ClearMessage()
{
 ...
 if (!fn) fn = UObject::FindObject<UFunction>(0xae275b8b);
...
{
	static UFunction* fn = nullptr; 
 if (!fn) fn = UObject::FindObject<UFunction>(0x5d6cb5f6);
...
{
	static UFunction* fn = nullptr; 
 if (!fn) fn = UObject::FindObject<UFunction>(0xaa039932);
...
{
	static UFunction* fn = nullptr; 
 if (!fn) fn = UObject::FindObject<UFunction>(0xedf071c8);
...
{
	static UFunction* fn = nullptr; 
 if (!fn) fn = UObject::FindObject<UFunction>(0x22a806be);
