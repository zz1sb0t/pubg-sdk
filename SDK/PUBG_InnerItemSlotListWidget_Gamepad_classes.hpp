...
public:
	...
	TArray<class UItemSlotWidget_Gamepad_C*>           ItemSlotArray;                                            // 0x0280(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance)
