...
struct FEventPayload
{
	...
	struct FMovieSceneEventParameters                  Parameters;                                               // 0x0008(0x0020) (CPF_Edit)
};
...
struct FMovieSceneActorReferenceSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	TArray<struct FGuid>                               ActorGuids;                                               // 0x00B0(0x0010) (CPF_ZeroConstructor)
};
...
struct FMovieSceneAudioSectionTemplateData
{
	...
	struct FScriptDelegate                             OnQueueSubtitles;                                         // 0x0108(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
	struct FScriptMulticastDelegate                    OnAudioFinished;                                          // 0x0118(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference)
	struct FScriptMulticastDelegate                    OnAudioPlaybackPercent;                                   // 0x0128(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference)
};
...
struct FMovieSceneCameraCutSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	struct FTransform                                  CutTransform;                                             // 0x0030(0x0030) (CPF_IsPlainOldData)
	bool                                               bHasCutTransform;                                         // 0x0060(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMovieSceneEventSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	TArray<struct FMovieSceneObjectBindingID>          EventReceivers;                                           // 0x0038(0x0010) (CPF_ZeroConstructor)
...
{
	class UMaterialParameterCollection*                MPC;                                                      // 0x0048(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FMovieSceneVectorPropertySectionTemplate : public FMovieSceneEvalTemplate
{
	...
	int                                                NumChannelsUsed;                                          // 0x0200(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	bool                                               bTemporarilyHiddenInGame;                                 // 0x00B0(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
