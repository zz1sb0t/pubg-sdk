...
bool UHudMain_C::OnInit_Delegate(class ATslBaseHUD** TslBaseHUD)
{
 ...
 if (!fn) fn = UObject::FindObject<UFunction>(0xdebb86d4);
...
{
	static UFunction* fn = nullptr; 
 if (!fn) fn = UObject::FindObject<UFunction>(0xbc0a1d6c);
...
{
	static UFunction* fn = nullptr; 
 if (!fn) fn = UObject::FindObject<UFunction>(0x43dba03b);
...
{
	static UFunction* fn = nullptr; 
 if (!fn) fn = UObject::FindObject<UFunction>(0x34ac6e81);
...
{
	static UFunction* fn = nullptr; 
 if (!fn) fn = UObject::FindObject<UFunction>(0x133f676a);
...
{
	static UFunction* fn = nullptr; 
 if (!fn) fn = UObject::FindObject<UFunction>(0xd5addcdc);
...
{
	static UFunction* fn = nullptr; 
 if (!fn) fn = UObject::FindObject<UFunction>(0x7b7e11d3);
